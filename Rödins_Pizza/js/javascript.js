...
$(document).ready(function (){
  ...
  document.getElementById("dot1").style.backgroundColor = "brown"; //använder javascript för att sätta ljusblå bakgrundsfärg på dot1 när slidern öppnas
...
$("#höger").click(function(){
    ...
    if (plats==0) {
        ...
        document.getElementById("dot3").style.backgroundColor = "brown"; //dot3 blir ljusblå när man befinner sig på sista bilden, vilket hjälper till att navigera vart man är i slidern
        ...
        document.getElementById("dot1").style.backgroundColor = "brown"; //dot1 blir ljusblå när man befinner sig på första bilden, vilket hjälper till att navigera vart man är i slidern
        document.getElementById("dot2").style.backgroundColor = "white"; //dot2 blir vit för att visa att man inte befinner sig på bild 2 i slidern
        ...
        document.getElementById("dot2").style.backgroundColor = "brown"; //dot2 blir ljusblå när man befinner sig på andra bilden, vilket hjälper till att navigera vart man är i slidern
        document.getElementById("dot3").style.backgroundColor = "white"; //dot3 blir vit för att visa att man inte befinner sig på bild 3 i slidern
...
$("#vänster").click(function(){
    ...
    if (plats==0) {
        ...
        plats++;    // samt att variabeln "plats" kommer öka med +1 efter att satsen exikverats
        document.getElementById("dot3").style.backgroundColor = "brown"; //dot3 blir ljusblå när man befinner sig på tredje bilden, vilket hjälper till att navigera vart man är i slidern
        document.getElementById("dot2").style.backgroundColor = "white"; //dot2 blir vit för att visa att man inte befinner sig på bild 2 i slidern
        document.getElementById("dot1").style.backgroundColor = "white"; //dot1 blir vit för att visa att man inte befinner sig på bild 1 i slidern
